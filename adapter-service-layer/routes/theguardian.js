...
router.get("/latest", async (req, res, next) => {
    ...
    // Get news
    const news = await theGuardianWrapper.getLatestCryptoNews(numberOfNews);
...
router.get("/search", async (req, res, next) => {
    ...
    // Get news
    const news = await theGuardianWrapper.getSpecificCryptoNews(fromDate, toDate, currency, numberOfNews);
